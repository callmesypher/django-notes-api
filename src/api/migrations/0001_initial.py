...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['owner', '-created_at'], name='api_note_owner_i_ee5734_idx')],
                'constraints': [models.UniqueConstraint(fields=('owner', 'title'), name='unique_note_title_per_user')],
            },
        ),
    ]
